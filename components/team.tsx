...
const teamMembers = [
  {
    name: "Riadi Zakaria",
    role: "Ingénieur d’État – General Manager",
    image:
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            chacun apportant une contribution unique. Ensemble, nous partageons
            une vision commune : offrir un service exceptionnel et dépasser les
            attentes de nos clients. Dans un environnement de travail
            collaboratif et innovant, nous encourageons la créativité et
            l’engagement. Découvrez les visages et les talents qui font de notre
            équipe un pilier de notre succès !
          </p>
        </div>
